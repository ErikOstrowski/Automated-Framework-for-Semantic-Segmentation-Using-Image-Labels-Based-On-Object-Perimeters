...
parser.add_argument('--gt_dir', default='./Dataset/VOC2012/SegmentationClass', type=str)
...
def do_python_eval(predict_folder, gt_folder, name_list, num_cls=21, num_cores=1):
    TP = []
    P = []
    T = []
    for i in range(num_cls):
